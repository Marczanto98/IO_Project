...
public class Information extends AppCompatActivity {
    ...
    private void initData() {
        ...
        movieList.add(new Info("ZAKAZ ZGROMADZEŃ I IMPREZ", "odwołania", "organizowania zgromadzeń, spotkań, imprez czy zebrań.", "Obowiązuje zakaz wszelkich zgromadzeń oraz imprez.\n" +
                "\n" +
        ...
        movieList.add(new Info("KOMUNIKACJA PUBLICZNA", "do odwołania", " przejazdów zbiorowym transportem publicznym.", "Zarządzający transportem publicznym mogą podwyższyć limit pasażerów środku transportu publicznego. Ile osób może wejść na pokład?\n" +
                "\n" +
